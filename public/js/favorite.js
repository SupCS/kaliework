...
const favoriteProductCards = Array.from(document.querySelectorAll(".product-card"));
...
const favoritePopupContainer = document.querySelector("#popup_favorite_container");
const favoriteProductList = document.querySelector("#popup_favorite_product_list");
